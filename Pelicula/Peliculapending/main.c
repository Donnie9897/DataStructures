...
void BuscarPeliculaPorAnno(Lista *listadoPeliculas);
...
int main()
{
    ...
    do
    {
        ...
        case Explorar:
            ...
            break;
        case Buscar:
            BuscarPeliculaPorAnno(listadoPeliculas);
            break;
        case Ordenar:
            break;
        }
...
eSeleccionmenu Mostrarmenu()
{
    ...
    do
    {
        ...
        gotoxy(5,5);
        printf("1: Agregar una pelicula al final");
        gotoxy(5,7);
        printf("2: Modificar una pelicula dado un ID");
        gotoxy(5,9);
        printf("3: Eliminar una pelicula dado su ID");
        gotoxy(5,11);
        printf("4: Agregar una pelicula en orden de a%co",164);
        gotoxy(5,13);
...
void BuscarPeliculaPorAnno(Lista *listadoPeliculas)
{
    ...
    mostrarmarco();
    gotoxy(10,3);
    printf("Buscar Pelicula existente por a%co.",164);
    gotoxy(5,7);
    do
    {
    ...
    {
        gotoxy(5,9);
        printf("La lista esta vacia. Presione cualquier letra para continuar.");
        fflush(stdin);
        getch();
        return;
    }
